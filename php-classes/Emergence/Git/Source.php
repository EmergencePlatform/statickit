...
class Source
{
    ...
    {
        static $habitatEnvironment;

        if (!$habitatEnvironment) {
            $habitatEnvironment = new HabitatEnvironment('core/git');
        }

        $env = $habitatEnvironment->getVariables();

        $env['GIT_SSH'] = $this->getSshWrapperPath();
